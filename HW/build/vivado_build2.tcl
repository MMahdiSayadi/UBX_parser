...
set useBoard 0
set uselibrary 0
set topmodule "UBX_parser_top"
set gen_dir "../"
set top_sim_name "UBX_parser_top"
...
set libdir [glob -nocomplain -directory $gen_dir/library *]
if { $uselibrary != 0 } {
	set_property  ip_repo_paths $libdir [current_project]
	update_ip_catalog
}
